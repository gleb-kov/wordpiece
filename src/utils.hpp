...
inline std::vector<uint32_t> parseText(const std::string &text, ThreadPool &thread_pool) {
...
inline std::vector<uint32_t> readTextFromFile(const std::string &filepath, ThreadPool &thread_pool) {
...
inline std::vector<std::vector<uint32_t>> parseVocab(const std::vector<std::string> &vocab) {
...
inline std::vector<std::vector<uint32_t>> readVocabFromFile(const std::string &filepath) {
    std::vector<std::vector<uint32_t>> vocab_utf8;
    std::ifstream fin(filepath);
    std::string word;
